    ...
    <section class="text-center mb-4">
        ...
        <div class="row wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
            ...
            if (isset($_POST['search']) ) 
            {
                $search = $_POST['search'];
                if (empty($search)) {
                    echo '<script language="javascript">alert("Chưa nhập dữ liệu vào ô tìm kiếm"); window.location="timkiem.php";</script>';   
                } 
                else
                {
                    $sql = "SELECT * FROM thongtinsanpham WHERE name LIKE '%$search%' OR name LIKE '$search%' OR name LIKE '%$search' ORDER BY time_sp DESC";
                            ...
                            <div class="col-lg-3 col-md-6 mb-4">
                                <div class="card">
                                    ...
                                    <div class="view overlay">
                                        <img src="<?php echo $imageURL1; ?>" class="card-img-top" alt="Hình ảnh sản phẩm">
